 ...
 *
 * [Script]
 * disney_check = type=generic,script-path=https://raw.githubusercontent.com/FirLeung/Oneself-Policy/main/JS/disney_check.js
 *
...
const DEFAULT_OPTIONS = {
  title: 'Disney+ 解锁检测',
  availableContent: '支持 Disney+ ➟  #REGION_NAME# #REGION_CODE#',
  availableIcon: undefined,
  availableIconColor: undefined,
  availableStyle: 'good',
  comingContent: 'Coming Soon ➟  #REGION_NAME# #REGION_CODE#',
