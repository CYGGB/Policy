 ...
 *
 * [Script]
 * nf_check = type=generic, script-path=https://raw.githubusercontent.com/FirLeung/Oneself-Policy/main/JS/nf_check.js, argument=title=Netflix 解锁检测
 *
...
const DEFAULT_OPTIONS = {
  title: 'Netflix 解锁检测',
  fullContent: 'Netflix : #REGION_NAME# #REGION_CODE#',
  fullIcon: 'checkmark.seal.fill',
  fullIconColor: '#33D600',
  fullStyle: 'good',
  onlyOriginalContent: '仅自制 : #REGION_NAME# #REGION_CODE#',
  onlyOriginalIcon: 'exclamationmark.triangle.fill',
  onlyOriginalIconColor: '#D6D500',
  onlyOriginalStyle: 'info',
  notAvailableContent: '不支持 Netflix',
  notAvailableIcon: 'xmark.seal.fill',
  notAvailableIconColor: '#D6D6D6',
  notAvailableStyle: 'alert',
  errorContent: '检测失败，请重试',
  errorIcon: 'power.circle.fill',
  errorIconColor: '#D60F00',
  errorStyle: 'error',
}
